...
It outputs "This account is currently not available."
...
`/usr/sbin/nologin` prints an output to help the user understand what happened while `/bin/false` outputs prohibits.