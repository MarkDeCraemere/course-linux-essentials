...
It returns the current time and how long the terminal has been open.
...
It makes the list more readable.
...
The files start with . and can be listed with ls -a.

### ✅ The man command

**Describe in your own words what the `man` command does.**
It shows you the manual of the command.
